 ...
 * 
 * "ace" is considered to be the smallest value.
...
public class Card
{
    ...
    * For a regular card (non-joker), the value must be in the range 1 through 13, with 1 representing an Ace.
    ...
    * Includes both the suit and the value
    * 	except that for a Joker with value 1, the return value is just "Joker"
